...
any bank change. The generator **enforces** the Spikenaut commit pin (`6965e12a`) with a SHA-256
per image, so changing any of the four images above without updating `BANK_DIGESTS` fails loudly
