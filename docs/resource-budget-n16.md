...
| Membrane state | One 16-entry × 16-bit register file, approximately 256 flip-flops before synthesis packing/optimization |
| Control | Neuron-index counter, input-index latch, result bitmap, and small IDLE/SWEEP sub-cycle FSM |
