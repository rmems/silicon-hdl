...
| Neuron count | **N=16** `LifNeuronArray` time-multiplexes one shared datapath across 16 neuron slots and commits `led[15:0]` as the spike bitmap | [#61](https://github.com/rmems/silicon-hdl/issues/61) |
